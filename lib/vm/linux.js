...
module.exports = class LinuxVM extends VM {
  ...
  _args() {
    ...
    // the console has to claim port 0 or hvc0 takes whichever id is free, and
    // mdev reads every port's name to symlink it
    args.push('-device', 'virtconsole,bus=vs0.0,chardev=con0,nr=0,name=console')
